...
browser.tr(:id, "name").text_field(:class, "gwt-TextBox").set "user12"
sleep 3
browser.tr(:id, /fullName/).text_field(:class, "gwt-TextBox").clear
browser.tr(:id, /fullName/).text_field(:class, "gwt-TextBox").set "user12"
sleep 3
browser.select_list(:class => "gwt-ListBox").select_value "Regulator"
sleep 3
...
browser.tr(:id, "password").text_field(:class, "gwt-PasswordTextBox").set "user12"
sleep 3
browser.tr(:id, "repeatpassword").text_field(:class, "gwt-PasswordTextBox").clear
browser.tr(:id, "repeatpassword").text_field(:class, "gwt-PasswordTextBox").set "user12"
#sleep 3
