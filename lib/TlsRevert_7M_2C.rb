...
class Test::Unit::TestCase
  filepath = File.dirname(__FILE__) + "/config/tlsrevert_7M_2C.yml"
...
class TlsDownloadVersionFileStatusCheck_4B < Test::Unit::TestCase
  ...
  def test_tls_download_version_file_status_check_4b
    ...
    puts "Expected Current Version: " + txt_current_version
    ...
    puts "Expected Available Version: " +SERVICES['tls_version_to']
    puts "Available Version         : " + txt_available_version
    assert_equal_browser(SERVICES['tls_version_to'], txt_available_version,"Oooops2! Incorrect upgrade version", browser)
    sleep 10
    
    assert_equal_browser(browser.button(:text, "Revert...").present?, true, "Ooooops3! Incorrect button action.", browser)
